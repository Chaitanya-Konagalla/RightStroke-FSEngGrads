...
@Component({
  selector: 'app-payment-pay-load',
  templateUrl: './payment-pay-load.component.html',
  styleUrls: ['./payment-pay-load.component.css']
})
export class PaymentPayLoadComponent implements OnInit {
