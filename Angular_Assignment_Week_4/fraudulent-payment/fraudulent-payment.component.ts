...
export class FraudulentPaymentComponent implements OnInit {
  ...
  banned_ac_msg="This account is blocked "+new Date();
  banned_curr_msg="This currency is banned please choose another currency "+new Date();
  Insuffiecient_msg="Insufficient amount in this accout"+ new Date();
  wrong_Id_msg="User Name is wrong enter a valid User Name"+new Date();
  wrong_Acc_msg=" You have entered a wrong account number "+new Date()
  success_msg="Payment is done successfully "+new Date()
  ExceedAmount_msg="You can only send maximum of 15000 per transaction "+new Date()
